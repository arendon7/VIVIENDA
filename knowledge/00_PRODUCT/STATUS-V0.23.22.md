...
1. **token collision:** un token repetido ya no puede iniciar I/O sobre un fixture activo;
...
3. `server/evidence-api/supabase-provider-fixture-support.test.ts`
4. `supabase/dev-fixtures/V0.23.22_PROVIDER_FIXTURE_SUPPORT.sql`
5. `knowledge/10_DECISIONS/ADR-0018-supabase-provider-fixture-adapter.md`
6. `knowledge/60_ENGINEERING/SUPABASE-PROVIDER-FIXTURE-ADAPTER-V0.23.22.md`
7. `knowledge/00_PRODUCT/STATUS-V0.23.22.md`
...
El head final de este STATUS debe confirmar:
